...
char gameLevel(){
    ...
    do{
        ...
        gamePart("line_small_right");
        colorSet(13);
        cout<<setw(29)<<right<<"SET THE DIFFICULTY\n";
        colorSet(4); //DARK RED 
        gamePart("SEPERATOR");
        colorSet(15); //WHITE
        cout<<"[1] ";
...
void setPuzzle(int level){
    //Variable
    string dot=".";
    string puzzle, highlight, solution;//Condition
    //EASY
    if(level == 1){
        puzzle = (" .7.8|3.1. | . . " + dot
               +  " .4. | .2.6|5. . " + dot 
...
void mainGame(){
    ...
    while(true){
        ...
        if (keyPress == 0 || keyPress == 224) { //If arrow keys and delete key pressed
            ...
            //MOVEMENT KEYS
            if (keyPress== 119 || keyPress== 87){ //UP
                upkey();
                break;
            }
...
void pauseGame(){
    do{
        ...
        gamePart("line_small_right");
        colorSet(13);
        cout<<setw(29)<<right<<"GAME PAUSED!!!\n";
        colorSet(4); //DARK RED 
        gamePart("SEPERATOR");
        colorSet(15); //WHITE
        cout<<"[1] ";
...
void helpSudoku (string located){
    ...
    <<" puzzle."<<endl
    <<"* If input number is correct, "<< endl
    <<" progess will increase."<<endl
...
void exitMenu(){
    do{
        ...
        gamePart("line_small_right");
        colorSet (13); //13 
        cout<<setw(25) <<right<<"DO YOU WANT TO EXIT? :("<<endl;
        colorSet(4); //DARK RED 
        gamePart("seperator");
        colorSet(15); //WHITE
        cout<<"[1]";
